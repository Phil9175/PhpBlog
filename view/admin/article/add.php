	...
	<li><button onclick="javascript:alignCenter();" class="alignCenter"></button>
			...
			<div id="fake_textarea" style="width:600px;height:200px;background-color:white;" contenteditable></div>
     	<?php
		$addArticle = new formulaire("addArticle", "", "POST", "/admin/article/add", "name");
		$addArticle->ajoutElement("Titre", "text", "titre", "", "titre", "", "", "", "", "", ""); 
		$addArticle->ajoutElement("", "hidden", "contenu", "", "contenu", "", "", "", "", "", "");
